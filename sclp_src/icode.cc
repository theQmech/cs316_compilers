...
{
	//TODO
	CHECK_INVARIANT(CONTROL_SHOULD_NOT_REACH, "virtual method get_reg not implementedin Ics_Opd");
}
...
string Icode_Stmt::get_Offset()
{
	CHECK_INVARIANT(CONTROL_SHOULD_NOT_REACH, "virtual method get_Offset not implemented");
}
...
{
	CHECK_INVARIANT((!opd1 && !opd2) || (opd1 && opd2),
		"Control_Flow_IC_Stmt: Invalid set of operands\n");
	string operation_name = op_desc.get_name();
...
Label_IC_Stmt::	Label_IC_Stmt(Tgt_Op inst_op, Ics_Opd * o1, string label)
{
